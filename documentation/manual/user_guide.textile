...
Start from v1.0-b4, PlayRythm support smart escape feature which escape expressions based on the template context. E.g.
...
# "Natural template":natural_template
# "Passing parameter with JSON string":json_parameter