...
h2. Migrate your current project from Groovy template engine to Rythm
...
# Step 2, annotate the relevant controller action method with @UseRythmTemplateEngine annotation
...
p(note). Tip: enclose all your rythm template with @#{verbatim}@ and @#{/verbatim}@ can help you avoid groovy compile exception and does not impact your rythm template

h2. Create an new project and use Rythm engine from the beginning
