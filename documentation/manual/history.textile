...
* <a href="reference#renderBody"><code>@renderBody()</code></a> does not do layout content now. It's specific to render tag body, instead, please use <a href="reference#render"><code>@render()</code></a> to render layout content
...
* <code>@renderSection()</code> now accept <a href="reference#default_section_content">default content block</a>
