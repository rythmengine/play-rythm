...
h2. <a name="v1.0.0-20121109">v1.0.0-20121109</a>

* New Feature
** <a href="">Add @_renderArgs@ implicit template variable</a>
** <a href="">Add @_render(String, Object...)@ interface to @TemplateBase@ to allow recursive render template
** "Do not detect template changes when "rythm.loadPreCompiled" is true":https://github.com/greenlaw110/Rythm/pull/90
