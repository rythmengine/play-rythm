...
h2. <a name="v1.0>v1.0.0</a>

* "Support groovy style null safe expression":nullable_expression
* "Support precompile - fast load on GAE":https://github.com/greenlaw110/Rythm/issues/31
* Bug fixes:
