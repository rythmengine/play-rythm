...
* Automatic escape expression using escapeHtml if the template file name suffix is .html. If your code breaks, try to use <a href="reference#raw"><code>@raw()</code></a> tag to surround relevant template part or export your variable with <code>.raw()</code> extension.
...
* improved template line number report in error screen
