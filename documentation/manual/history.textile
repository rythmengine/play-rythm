...
* Add new dialect to attract current Groovy, Japid template users-. At least not at the moment
...
* Support @for(int i = 0; i < 100; ++i) loop style
* New keyword: <code>@return()</code>: abort current template executing process and return to caller
