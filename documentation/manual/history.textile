...
h2. <a name="v1.0-b10">v1.0-b10</a>

Update to rythm-engine-1.0-b11-SNAPSHOT

* Enhancements
** "Add support to ehcache":https://github.com/greenlaw110/Rythm/issues/200
** "Add support to commons-logging":https://github.com/greenlaw110/Rythm/issues/198

* Bug fixes:
** "JavaTag is not favored":https://github.com/greenlaw110/Rythm/issues/203
** "question mark inside expression is filtered out unexpectedly":https://github.com/greenlaw110/Rythm/issues/202
** "else and spaces":https://github.com/greenlaw110/Rythm/issues/193
** "(gae) Model classes cannot be resolved":https://github.com/greenlaw110/Rythm/issues/191
** "Fix issue with GAE and shutdown":https://github.com/greenlaw110/Rythm/issues/190
** "(gae) the app config shouldn't need modification to support GAE":https://github.com/greenlaw110/Rythm/issues/189
** "Cannot run in GAE":https://github.com/greenlaw110/Rythm/issues/187
...
h2. <a name="v1.0-b9l">v1.0-b9l</a>

p(note). **Break change**: package name renamed from @com.greenlaw110.rythm@ to @org.rythmengine@

* Changes:
** disable template preloading when running on precompile mode. This helps to solve the issue of bootup failure on GAE
