...
Welcome to PlayRythm module documentation. This documentation is intended for the *0.9.8 beta release* and may significantly differ from previous module version's documentation.
...
# Static and strong typed pure Java template. Yes it's like "Japid":http://www.playframework.org/modules/japid and "Jamon":www.jamon.org
# "Razor":http://weblogs.asp.net/scottgu/archive/2010/07/02/introducing-razor.aspx like syntax
# Easy to "integrate with Play":integration. There is no special controller needed at all
# Automatic dynamic expression escape, like "Groovy":http://www.playframework.org/documentation/1.2.4/templates and unlike "Japid":http://www.playframework.org/modules/japid-0.9.3.4/home#JavaExpressionexpressionandexpression
...
# Support "FastTags":user_guide#fast_tags and "JavaExtensions":user_guide#java_extension with constraints
# Cache "tag invocation":user_guide#tag_invocation_cache and "template blocks":reference#cache
# Assign "tag invocation":user_guide#tag_invocation_assign and "template blocks":reference#assign to a template variable for further process or delayed output
# "Invoke controller action method":user_guide#invoke_action directly from within your template
