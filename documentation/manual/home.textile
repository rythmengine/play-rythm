...
p(note). 1.0-RC8 is an emergent release to fix issue "#58":https://github.com/greenlaw110/Rythm/issues/58 introduced in RC7

Welcome to *PlayRythm module* documentation. This documentation is intended for the *1.0.0-RC9 release* and might be significantly differ from previous module version's documentation.
