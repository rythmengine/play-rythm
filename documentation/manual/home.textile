...
Welcome to PlayRythm module documentation. This documentation is intended for the *0.9.7b beta release* and may significantly differ from previous module version's documentation.
...
h4. 1. Add PlayRythm into your @dependencies.conf@ file:
