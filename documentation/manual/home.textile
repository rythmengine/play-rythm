...
Welcome to PlayRythm module documentation. This documentation is intended for the *1.0.0-RC3 release* and is significantly differ from previous module version's documentation.
...
# (Play specific) "Support GAE":integration#configuration
